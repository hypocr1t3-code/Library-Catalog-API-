...
Revision ID: 40ccab0d8102
Revises: 
Create Date: 2026-09-14 16:06:15.643229
...
def upgrade() -> None:
    ...
    op.create_index('idx_books_author_year', 'books', ['author', 'year'], unique=False)
    op.create_index('idx_books_genre_available', 'books', ['genre', 'available'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_books_genre_available', table_name='books')
    op.drop_index('idx_books_author_year', table_name='books')
    op.drop_table('books')
    # ### end Alembic commands ###
